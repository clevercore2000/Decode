...
@TeleOp(name = "Solo Teleop", group = "Drive")
public class SoloTeleop extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            outtakeToggle.update(gamepad1.cross);

            if (gamepad1.right_bumper && !lastRightBumper) outtakeFast = true;
            if (gamepad1.left_bumper && !lastLeftBumper) outtakeFast = false;
            ...
            outtake.rampShoot(gamepad1.dpad_up);
            outtake.update();
